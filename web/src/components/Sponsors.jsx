...
function Sponsors() {
  ...
  return (
    <>
      ...
      <section className="sponsor-hero">
        <div className="sponsor-story">
          ...
          <div className="loom-cta-row">
            <button className="loom-cta" type="button" onClick={handleOpenLoom} aria-haspopup="dialog">Weave a few threads</button>
      ...
      {isLoomOpen && (
        <div className="modal-overlay modal-overlay--full is-open" role="dialog" aria-modal="true" aria-labelledby="loom-title" aria-describedby="loom-subtitle">
          <div className="modal-card modal-card--fullscreen loom-modal-card" role="document" aria-describedby="loom-subtitle">
